...
function(check_linker_supports_version_file VAR)
  ...
  if(CMAKE_C_COMPILER_LINKER_ID MATCHES "^(MSVC)$")
    ...
    check_c_source_compiles("int func(void) {return 0;} int main(int argc,char*argv[]){(void)argc;(void)argv;return func();}" ${VAR} FAIL_REGEX "(unsupported|syntax error|unrecognized option|ignoring unknown argument|unknown file type)")
